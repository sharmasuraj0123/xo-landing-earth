...
const testimonials = [
  {
    quote: "We shipped a full Linear triage agent. It closes tickets. We pay when tickets close.",
    author: "Rahul Mehta",
    role: "CTO",
    company: "Crestline AI",
    metric: { value: "73%", label: "Lower cost per ticket" },
  },
  {
    quote: "The workspace runs the same in our Coder setup and on my laptop. One image, no drift.",
    author: "Tanya Osei",
    role: "Platform Lead",
    company: "Lattice Works",
    metric: { value: "0", label: "Environment mismatches" },
  },
  {
    quote: "BYOM means we control the model. XO handles everything else.",
    author: "Diego Varela",
    role: "Head of Engineering",
    company: "Forma Labs",
    metric: { value: "4x", label: "Models in production" },
  },
  {
    quote: "Every agent run has a budget cap and a verification step. Finance finally trusts it.",
    author: "Mei Tanaka",
    role: "VP Operations",
    company: "Sora Systems",
    metric: { value: "100%", label: "Auditable outcomes" },
  },
];
...
export function TestimonialsSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-16 lg:py-20 bg-foreground text-background overflow-hidden">
